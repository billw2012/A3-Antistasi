...
private ["_marcador","_vehiculos","_grupos","_soldados","_posicion","_pos","_size","_veh","_estaticas","_garrison","_tam","_cuenta","_grupo","_cuentaGrupo","_garrisonGroups","_grupoMort","_tipo","_unit"];
